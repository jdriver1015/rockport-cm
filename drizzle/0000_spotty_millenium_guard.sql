...
CREATE TYPE "public"."project_stage" AS ENUM('setup', 'bidding', 'mobilization', 'in_progress', 'punch_walk', 'final_completion', 'closed');--> statement-breakpoint
CREATE TYPE "public"."punch_status" AS ENUM('open', 'resolved');--> statement-breakpoint
CREATE TYPE "public"."scope_group" AS ENUM('exterior', 'landscape', 'amenity', 'mep', 'interior', 'contingency_fee');--> statement-breakpoint
CREATE TYPE "public"."scope_status" AS ENUM('not_started', 'bidding', 'in_progress', 'complete', 'deferred');--> statement-breakpoint
CREATE TYPE "public"."turn_stage" AS ENUM('planned', 'vacant_ready', 'in_progress', 'punch', 'complete', 'invoiced', 'leased');--> statement-breakpoint
...
CREATE TABLE "projects" (
	...
	"unit_count" integer,
	"pm_system" text,
	"stage" "project_stage" DEFAULT 'setup' NOT NULL,
	"start_date" date,
...
CREATE TABLE "scopes" (
	...
	"cost_code_id" integer NOT NULL,
	"name" text NOT NULL,
	"group" "scope_group" NOT NULL,
	"status" "scope_status" DEFAULT 'not_started' NOT NULL,
	"vendor_id" integer,
	"start_date" date,
	"complete_date" date,
...
--> statement-breakpoint
CREATE TABLE "turn_stage_events" (
	"id" serial PRIMARY KEY NOT NULL,
	"turn_id" integer NOT NULL,
	"from_stage" "turn_stage",
	"to_stage" "turn_stage" NOT NULL,
	"user_id" uuid,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "unit_turns" (
	...
	"project_id" integer NOT NULL,
	"stage" "turn_stage" DEFAULT 'planned' NOT NULL,
	"start_date" date,
	"complete_date" date,
...
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_scope_id_scopes_id_fk" FOREIGN KEY ("scope_id") REFERENCES "public"."scopes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_unit_turn_id_unit_turns_id_fk" FOREIGN KEY ("unit_turn_id") REFERENCES "public"."unit_turns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "gl_transactions" ADD CONSTRAINT "gl_transactions_scope_id_scopes_id_fk" FOREIGN KEY ("scope_id") REFERENCES "public"."scopes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gl_transactions" ADD CONSTRAINT "gl_transactions_unit_turn_id_unit_turns_id_fk" FOREIGN KEY ("unit_turn_id") REFERENCES "public"."unit_turns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "import_batches" ADD CONSTRAINT "import_batches_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "punch_items" ADD CONSTRAINT "punch_items_unit_turn_id_unit_turns_id_fk" FOREIGN KEY ("unit_turn_id") REFERENCES "public"."unit_turns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "punch_items" ADD CONSTRAINT "punch_items_scope_id_scopes_id_fk" FOREIGN KEY ("scope_id") REFERENCES "public"."scopes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "scopes" ADD CONSTRAINT "scopes_cost_code_id_cost_codes_id_fk" FOREIGN KEY ("cost_code_id") REFERENCES "public"."cost_codes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "scopes" ADD CONSTRAINT "scopes_vendor_id_vendors_id_fk" FOREIGN KEY ("vendor_id") REFERENCES "public"."vendors"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "turn_stage_events" ADD CONSTRAINT "turn_stage_events_turn_id_unit_turns_id_fk" FOREIGN KEY ("turn_id") REFERENCES "public"."unit_turns"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "turn_stage_events" ADD CONSTRAINT "turn_stage_events_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "unit_turns" ADD CONSTRAINT "unit_turns_unit_id_units_id_fk" FOREIGN KEY ("unit_id") REFERENCES "public"."units"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "unit_turns" ADD CONSTRAINT "unit_turns_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
