  ...
  if (batch.status === "needs_mapping") {
    ...
    return (
      <div className="space-y-6">
        <div>
          <p className="text-sm">
            <Link href={`/properties/${slug}/gl`} className="text-link hover:underline">
              ← Import history
            </Link>
          </p>
          <div className="mt-1 flex flex-wrap items-center gap-3">
            ...
            <DeleteBatchButton propertySlug={slug} batchId={batch.id} fileName={batch.fileName} />
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <GlColumnMapper propertySlug={slug} batchId={batch.id} sheets={sheets} />
          </CardContent>
        </Card>
      </div>
    );
    ...
    return (
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <GlAccountPicker propertySlug={slug} batchId={batch.id} accounts={accounts} />
          </CardContent>
        </Card>
      </div>
    );
              ...
              <div className="flex gap-2">
                {postedPage <= 1 ? (
                  ...
                  <Button
                    ...
                    render={
                      <Link
                        href={`/properties/${slug}/gl/${batchId}?postedPage=${postedPage - 1}`}
                      />
                    }
                  >
                    Previous
